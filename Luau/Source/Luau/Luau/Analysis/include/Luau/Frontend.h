...
struct Frontend
{
    ...
    CheckResult lua_check(const ModuleName& name, std::optional<FrontendOptions> optionOverride = {}); // new shininess
...
private:
    ModulePtr lua_check(const SourceModule& sourceModule, Mode mode, const ScopePtr& environmentScope);
