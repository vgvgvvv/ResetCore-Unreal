...
struct TypeChecker
{
    ...
    ModulePtr lua_check(const SourceModule& module, Mode mode, std::optional<ScopePtr> environmentScope = std::nullopt);
    ...
    void lua_check(const ScopePtr& scope, const AstStat& statement);
    void lua_check(const ScopePtr& scope, const AstStatBlock& statement);
    void lua_check(const ScopePtr& scope, const AstStatIf& statement);
    void lua_check(const ScopePtr& scope, const AstStatWhile& statement);
    void lua_check(const ScopePtr& scope, const AstStatRepeat& statement);
    void lua_check(const ScopePtr& scope, const AstStatReturn& return_);
    void lua_check(const ScopePtr& scope, const AstStatAssign& assign);
    void lua_check(const ScopePtr& scope, const AstStatCompoundAssign& assign);
    void lua_check(const ScopePtr& scope, const AstStatLocal& local);
    void lua_check(const ScopePtr& scope, const AstStatFor& local);
    void lua_check(const ScopePtr& scope, const AstStatForIn& forin);
    void lua_check(const ScopePtr& scope, TypeId ty, const ScopePtr& funScope, const AstStatFunction& function);
    void lua_check(const ScopePtr& scope, TypeId ty, const ScopePtr& funScope, const AstStatLocalFunction& function);
    void lua_check(const ScopePtr& scope, const AstStatTypeAlias& typealias, int subLevel = 0, bool forwardDeclare = false);
    void lua_check(const ScopePtr& scope, const AstStatDeclareClass& declaredClass);
    void lua_check(const ScopePtr& scope, const AstStatDeclareFunction& declaredFunction);
